...
- `VerificationEngine`：封装 PySR，自动搜索低复杂度、可解释的候选物理公式。
- `HypothesisBrain`：调用兼容 OpenAI SDK 的大模型 API，对轨迹统计摘要进行“物理学家式”判断与反思。
...
🧠 Agent 正在观察数据并生成统计摘要...
💻 正在启动 PySR 符号回归，请耐心等待...
📘 完成回归后将自动生成 Markdown 科研报告...
========================================================================
✅ 科研循环执行完成。
========================================================================
【符号回归结果】
最优公式: 3.01 * square(v) * a
Loss: 0.000000123456
Complexity: 8.000000
========================================================================
